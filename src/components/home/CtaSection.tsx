    ...
    <div className="border border-[rgba(3,7,18,0.1)] border-solid relative size-full" data-node-id="54:1337" data-name="Border">
      <div className="absolute h-[615px] overflow-clip right-[-1px] top-0 w-[1600px]" data-node-id="54:1338" data-name="grid.svg">
        <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[616px] left-1/2 top-[calc(50%+0.5px)] w-[1600px]" data-node-id="54:1339" data-name="grid.svg">
          <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGridSvg} />
        </div>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute bg-clip-text flex flex-col font-['Space_Grotesk:Medium'] font-medium justify-center leading-[0] left-[380.02px] right-[372.98px] text-[120px] text-[transparent] text-center top-[calc(50%-110px)] tracking-[-7.2px] uppercase whitespace-nowrap" data-node-id="54:1341" style={{ backgroundImage: "linear-gradient(140.4438116569271deg, rgb(85, 89, 92) 21.13%, rgb(0, 0, 0) 80.53%)" }}>
      ...
      <div className="-translate-y-1/2 absolute contents left-[1405px] right-[72px] top-[calc(50%-161px)]" data-node-id="54:1461">
        <div className="-translate-y-1/2 absolute aspect-[26/32] left-[1406px] opacity-15 overflow-clip right-[168px] top-[calc(50%-161px)]" data-node-id="54:1351" data-name="arrow-left.svg">
        ...
        <div className="-translate-y-1/2 absolute aspect-[26/32] left-[1454px] opacity-15 overflow-clip right-[120px] top-[calc(50%-161px)]" data-node-id="54:1367" data-name="arrow-left.svg">
        ...
        <div className="-translate-y-1/2 absolute aspect-[27/32] left-[1500px] opacity-15 overflow-clip right-[73px] top-[calc(50%-161px)]" data-node-id="54:1383" data-name="arrow-left.svg">
