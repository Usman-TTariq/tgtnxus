const img01Svg = "https://www.figma.com/api/mcp/asset/d4d66423-2ddc-454b-bee5-edd2f81ae258";
const img02Svg = "https://www.figma.com/api/mcp/asset/4a240ccf-8acf-407e-a6a3-df87abc8c92e";
const img03Svg = "https://www.figma.com/api/mcp/asset/129a7b8c-2afd-4bf8-8d13-470f943f5f74";
...
export default function ResultsSection() {
  return (
    <div className="relative w-full h-full" data-node-id="24:14">
      ...
      <div className="absolute border-[#dee2e6] border-solid border-t h-[135px] left-0 right-0 top-[95px]" data-node-id="3:3755" data-name="Item">
        <div className="-translate-y-1/2 absolute left-[56px] overflow-clip size-[72px] top-[calc(50%+0.39px)]" data-node-id="3:3756" data-name="01.svg">
          <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[72px] top-1/2" data-node-id="3:3757" data-name="01.svg">
            <img alt="" className="absolute block inset-0 max-w-none size-full" src={img01Svg} />
          </div>
        </div>
      ...
      <div className="absolute border-[#dee2e6] border-solid border-t h-[135px] left-0 right-0 top-[230px]" data-node-id="3:3782" data-name="Item">
        <div className="-translate-y-1/2 absolute left-[56px] overflow-clip size-[72px] top-[calc(50%+0.39px)]" data-node-id="3:3783" data-name="02.svg">
          <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[72px] top-1/2" data-node-id="3:3784" data-name="02.svg">
            <img alt="" className="absolute block inset-0 max-w-none size-full" src={img02Svg} />
          </div>
        </div>
      ...
      <div className="absolute border-[#dee2e6] border-solid border-t h-[135px] left-0 right-0 top-[365px]" data-node-id="3:3827" data-name="Item">
        <div className="-translate-y-1/2 absolute left-[56px] overflow-clip size-[72px] top-[calc(50%+0.39px)]" data-node-id="3:3828" data-name="03.svg">
          <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[72px] top-1/2" data-node-id="3:3829" data-name="03.svg">
            <img alt="" className="absolute block inset-0 max-w-none size-full" src={img03Svg} />
          </div>
        </div>
